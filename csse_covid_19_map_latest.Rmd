...
radius_multiplier <- 2E5 / max(log(plot_data$Deaths + 1), na.rm = TRUE)
```

## Deaths

In this view, the radius of the circle is proportional to the logarithm of the death toll at the latest time point.
